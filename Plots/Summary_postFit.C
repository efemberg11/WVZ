...
// ------------>Primitives in pad: pad1
   ...
   Graph_g_ratio23013->SetMinimum(0.9);
   Graph_g_ratio23013->SetMaximum(2.1);
...
// ------------>Primitives in pad: pad0
   ...
   Graph_Graph_from_h_Tot_summary3015->SetMinimum(1517.961);
   Graph_Graph_from_h_Tot_summary3015->SetMaximum(3665.071);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.12,0.7649999,"Post-fit");
tex->SetNDC();
   tex->SetTextFont(43);
   tex->SetTextSize(23);
   tex->SetLineWidth(2);
